...
The reason why we did this is to convert the standard date-time format to a number format, as it acts as one of the input for Random Forest Regressor. \\
...
\paragraph{6.2 Weekend Vs Weekday Trend} ~\\
